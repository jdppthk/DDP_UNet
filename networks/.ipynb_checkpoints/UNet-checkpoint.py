...
def up_conv(in_channels, out_channels):
    return nn.Sequential(
        nn.ConvTranspose2d(in_channels, out_channels, 4, stride=2, padding=1, output_padding=0),
...
class UNet(nn.Module):
    ...
    def __init__(self, params):
        ...
        self.conv_last = nn.ConvTranspose2d(64+64, params.N_out_channels, 4, stride=2, padding=1, output_padding=0)
